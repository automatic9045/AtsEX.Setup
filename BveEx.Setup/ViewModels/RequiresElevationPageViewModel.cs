...
namespace BveEx.Setup.ViewModels
{
    public class RequiresElevationPageViewModel : IPageViewModel, INotifyPropertyChanged, IDisposable
    {
        ...
        public string Description { get; } = "指定されたフォルダへ BveEX をインストールするには管理者権限が必要です。インストールを続行する方法を選択してください。";
                ...
                switch (Option.Value)
                {
                    ...
                    case ElevationOption.CopyBve:
                        MessageBoxResult result = MessageBox.Show(
                            ...
                            "この設定でインストールを開始しても本当によろしいですか?", "BveEX セットアップウィザード", MessageBoxButton.YesNo, MessageBoxImage.Warning);
